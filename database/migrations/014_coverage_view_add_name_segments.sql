...
COMMENT ON VIEW public.coverage_metrics IS 'Data coverage per company: orgnr, name, segment_names, has_homepage, has_ai_profile, has_3y_financials, last_enriched_at, data_quality_score (0-4).';
