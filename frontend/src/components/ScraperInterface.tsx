      ...
      <div className="relative space-y-10">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="space-y-3">
            <span className="text-xs uppercase tracking-[0.35em] text-muted-foreground">Scraper suite</span>
        ...
        <div className="rounded-2xl border border-accent/50 bg-accent/50 p-6 text-foreground shadow-[0_18px_45px_-30px_hsl(var(--accent) / 0.45)]">
          <div className="flex items-start gap-4">
            <AlertTriangle className="h-5 w-5 text-foreground" />
            <div className="space-y-2">
              <h4 className="text-sm font-semibold uppercase tracking-wide text-foreground">Large session performance</h4>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          <TabsList className="grid w-full grid-cols-3 rounded-full border border-border/20 bg-muted/15 p-1 text-muted-foreground">
            <TabsTrigger
              value="overview"
              className="flex items-center justify-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition data-[state=active]:bg-card data-[state=active]:text-primary-foreground data-[state=active]:shadow-[0_18px_35px_-25px_hsl(var(--chart-2) / 0.6)]"
            >
            ...
            <TabsTrigger
              value="validation"
              className="flex items-center justify-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition data-[state=active]:bg-card data-[state=active]:text-primary-foreground data-[state=active]:shadow-[0_18px_35px_-25px_hsl(var(--chart-2) / 0.6)] data-[disabled]:cursor-not-allowed data-[disabled]:opacity-40"
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card className={`${glassPanelClass} p-6`}>
              <CardHeader className="border-none p-0 pb-4">
                <CardTitle className="text-lg font-semibold text-primary-foreground">Getting started</CardTitle>
                <CardDescription className="text-sm text-muted-foreground">
              ...
              <CardContent className="grid grid-cols-1 gap-6 p-0 md:grid-cols-2">
                <div className="space-y-3">
                  <h4 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">Session management</h4>
                  <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <div className="space-y-3">
                  <h4 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">Data validation</h4>
                  <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <Card className={`${glassPanelClass} p-6`}>
                <CardContent className="flex items-center justify-center p-8">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">Select a session to review validation insights.</p>
                    <p className="text-xs text-muted-foreground">Head to the Sessions tab and choose a run to begin.</p>
                  </div>
                </CardContent>
              </Card>
            )}
