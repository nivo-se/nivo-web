      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto">
          <FadeIn delay={100} direction="up">
            <span className="text-sm md:text-base font-medium text-primary mb-2 inline-block text-center block">Om oss</span>
          </FadeIn>
          <TextReveal delay={200} duration={1000}>
            <h2 className="text-3xl md:text-4xl font-heading text-foreground mb-10 text-center">Med djup erfarenhet driver Nivo hållbar tillväxt</h2>
          </TextReveal>

          <FadeIn delay={400} duration={900} direction="up">
            <p className="text-base leading-relaxed mb-8 text-center text-foreground/85 sm:text-lg">
          ...
          <FadeIn delay={600} duration={900} direction="up">
            <p className="text-base leading-relaxed text-foreground/75 text-center sm:text-lg">
