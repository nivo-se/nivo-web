...
const About: React.FC<AboutProps> = ({ className, id }) => {
  return (
    <section id={id} className={cn('py-16 md:py-28 bg-card', className)}>
          ...
          <FadeIn className="md:col-span-4" delay={100}>
            <div className="md:sticky md:top-32">
              ...
              <TextReveal delay={300} duration={1000}>
                <h2 className="text-2xl md:text-3xl font-heading font-semibold tracking-tight text-foreground">Ett team av erfarna företagsbyggare</h2>
              </TextReveal>
            </div>
          </FadeIn>
