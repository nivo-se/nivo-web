...
import { useCompanies, useLists, useProspects, useAIRuns } from "@/lib/hooks/figmaQueries";
      ...
      <div className="max-w-5xl mx-auto px-8 py-8">
        ...
        <div className="mb-8">
          ...
          {researchLists.length > 0 && (
            <div className="mb-6">
              <h3 className="text-sm font-medium text-gray-600 mb-3 uppercase">Research</h3>
          ...
          {aiAnalysisLists.length > 0 && (
            <div>
              <h3 className="text-sm font-medium text-gray-600 mb-3 uppercase">AI Analysis</h3>
              <div className="space-y-3">
